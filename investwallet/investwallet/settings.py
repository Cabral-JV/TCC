"""
Django settings for investwallet project.
...
# SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "django-insecure-4@#)8&!$@*0g3v1j5q2r7z6x@9^+8!@#)8&!$@*0g3v1j5q2r7z6x@9^+8!@#")
...
ROOT_URLCONF = "investwallet.urls"
...
WSGI_APPLICATION = "investwallet.wsgi.application"
